					...
					<table>
						...
						<tr>
							...
							<td><input type="text" id="bairro" name="bairro"
								value="${user.bairro}" placeholder="Informe o bairro do usuário"></td>
						</tr>
						<tr>
							<td>Nome:</td>
						...
						<tr>
							...
							<td><input type="text" id="telefone" name="telefone"
								value="${user.telefone}"
								placeholder="Informe o telefone do usuário"></td>

							<td>Estado:</td>
							<td><input type="text" id="estado" name="estado"
								value="${user.estado}" placeholder="Informe o estado do usuário"></td>
						</tr>
						<tr>
							<td>IBGE:</td>
							<td><input type="text" id="ibge" name="ibge"
								value="${user.ibge}" placeholder="Informe o código do IBGE"></td>
						</tr>
						<tr>
							<td>Foto:</td>
